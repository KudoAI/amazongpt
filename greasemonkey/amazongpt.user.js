...
// @require                https://cdn.jsdelivr.net/npm/@kudoai/chatgpt.js@4.15.0/dist/chatgpt.min.js#sha256-RglS1MscMHGDI7nq1v0OXEHoEw8stDxErRzSuILzCrQ=
...
// @require                https://cdn.jsdelivr.net/gh/adamlui/ai-web-extensions@54d802d/assets/js/chatbot/components/icons.js#sha256-jkkDED+okQy2g7vBEZfME9a4PphdFWzc44FBnwk0Xz0=
...
// @require                https://cdn.jsdelivr.net/gh/adamlui/ai-web-extensions@5b1e38a/assets/js/chatbot/lib/api.js#sha256-VhJveQa7jqaUngCAZSBD57GwNgiw2W1eWWcEueuO9Wo=
...
// @require                https://cdn.jsdelivr.net/gh/adamlui/ai-web-extensions@54d802d/assets/js/chatbot/lib/themes.js#sha256-4BhqqdRpkS9w+lVzCao2vgfZUVM8pfxeTTgFGO/5dJo=
// @require                https://cdn.jsdelivr.net/gh/adamlui/ai-web-extensions@54d802d/assets/js/chatbot/lib/ui.js#sha256-ngPXDUxF7bdYpxwHqNyuzPJ/QKdQGCUzcR1feZZH1ms=
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: {
            ...
            aiweb: '294a418' // for cached ai-chat-apis.json5 + <code-languages|katex-delimiters|sogou-tts-lang-codes>.json
        },
    ...
    window.show = {
        ...
        reply({ content, apiUsed = null }) {
            ...
            if (!show.reply.chatbarFocused // do only once
                ...
                && (!app.config.autoFocusChatbarDisabled // AF enabled
                    || (  // ...or AF disabled & user interacted
                        app.config.autoFocusChatbarDisabled && show.reply.userInteracted))
        ...
        createAppend() { // requires lib/<dom|settings>.js + <app|env>
            ...
            function moveThumb(newLeft) {
                ...
                const replyPre = app.div.querySelector('.reply-pre'),
                      ...
                      fontSize = app.config.minFontSize
                               + fontSizePercent *( app.config.maxFontSize - app.config.minFontSize )
    ...
    ui.addListeners.appDiv() ; if (app.config.expanded) app.div.classList.add('expanded')
    update.appStyle()
